...
if DevRio:get(x.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(x.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(x.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
xName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if xName then 
xNames = DevRio:smembers(x.."Rio:Mute:Names"..msg.chat_id_) or ""
...
DevRio:set(x.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(x.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
