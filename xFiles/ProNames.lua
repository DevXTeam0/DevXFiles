...
DevAbs:set(x.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(x.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(x.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(x.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(x.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(x.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(x.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(x..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(x.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(x.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAbs:sadd(x..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAbs:del(x.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
