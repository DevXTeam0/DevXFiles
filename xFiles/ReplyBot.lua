...
xTEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
xTEAM =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
xTEAM =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
xTEAM =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
xTEAM =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local xTEAM = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DevRio2 = math.random(#xTEAM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM[DevRio2] , 1, 'md') 
return false
end
...
local xTEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DevRio2 = math.random(#xTEAM) 
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM[DevRio2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
xTEAM =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
...
xTEAM =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
xTEAM =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
xTEAM =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md')
return false
end
if text == 'فرخ' or text == 'فرخه' then
xTEAM =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md') 
return false
end
...
xTEAM =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_Rio(msg.chat_id_, msg.id_, 1, xTEAM, 1, 'md')
return false
end
end
