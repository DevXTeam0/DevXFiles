...
if DevRio:get(DevX.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(DevX..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevX == 5 or DevX == tags or k == 0 then
tags = DevX + 5
t = "#all"
end
DevX = DevX + 1
